# ubi_client/exceptions.py

This module defines the errors the UBI client raises. It was adapted from `ubi_client/exceptions.py` in the old tradingmachine project, kept at `/run/media/pramod/6959D90B1DAD7E59/backup_20260910/pramod/Downloads/tradingmachine-master/`.

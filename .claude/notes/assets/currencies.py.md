# assets/currencies.py

This module holds the six currency classes: `Currency`, `CurrencyFutures`, `CurrencyOption`, `CurrencyIndex`, `CurrencyIndexFutures` and `CurrencyIndexOption`. They were ported on 2026-09-20 from `assets/currencies.py` in the old tradingmachine project at `/run/media/pramod/6959D90B1DAD7E59/backup_20260910/pramod/Downloads/tradingmachine-master/`. Funds and mutual funds are the last families still to come.

It is a copy of `assets/commodities.py`, which is a copy of the two before it. Nothing was factored out and no existing module was touched.
...
The construction pattern and its reasoning follow the earlier modules and are recorded in `.claude/notes/assets/equities.py.md`.

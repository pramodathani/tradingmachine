...
Each method fetches the instrument's candles through `prices` and reduces one column to a number, a summary or a histogram. The class is inherited by `assets.instruments.Instrument`, which supplies `prices`.
